...
def makeWebhookResult(req):
    ...
    if req.get("queryResult").get("action")=='getpincode':
        ...
        if conn is False:
            ...
            return {"fulfillmentText":"The total amount is Rs. 250. Your order will be delivered to "+pincode+" in 30 minutes. You have ordered "+pizza_type,pizza_size+" with "+pizza_crust+" crust. Your order id is "+str(order_id)+". Enter your order id to check status"}
